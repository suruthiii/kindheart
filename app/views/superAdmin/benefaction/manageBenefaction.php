                ...
                <table>
                    ...
                    <?php if($data['benefaction_details']->itemPhoto1 != NULL) {?>
                        <tr class="necessity-data">
                            ...
                            <td width="70%">
                                <img src="<?php echo URLROOT ?>/nic/<?php print_r($data['benefaction_details']->itemPhoto1); ?>" class="user-img" alt="">
                            </td>
                        </tr>
                    <?php }?>
                    <?php if($data['benefaction_details']->itemPhoto2 != NULL) {?>
                        <tr class="necessity-data">
                            ...
                            <td width="70%">
                                <img src="<?php echo URLROOT ?>/nic/<?php print_r($data['benefaction_details']->itemPhoto2); ?>" class="user-img" alt="">
                            </td>
                        </tr>
                    <?php }?>
                    <?php if($data['benefaction_details']->itemPhoto3 != NULL) {?>
                        <tr class="necessity-data">
                            ...
                            <td width="70%">
                                <img src="<?php echo URLROOT ?>/nic/<?php print_r($data['benefaction_details']->itemPhoto3); ?>" class="user-img" alt="">
                            </td>
                        </tr>
                    <?php }?>
