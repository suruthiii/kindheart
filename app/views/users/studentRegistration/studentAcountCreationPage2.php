                    ...
                    <form action="<?php echo URLROOT ?>/users/studentAcountCreationPage2" method="POST">
                        <div class="studentAcountCreationPage2-inner-container-form-container-inputfeilds">
                            ...
                            <div class="studentAcountCreationPage2-inner-container-form-container-inputfeilds-feild1">
                                <input class="studentAcountCreationPage2-input" type="text" name="username" id="username-field" value="<?php echo $data['username']?>" required>
                                <p class="error-message" for="username"><?php echo $data['username_err']?></p>
                            </div>

                            <label for="password">Enter Password</label>
                            <div class="studentAcountCreationPage2-inner-container-form-container-inputfeilds-feild1">
                                <input class="studentAcountCreationPage2-input" type="password" name="password" id="password" value="<?php echo $data['password']?>" required>
