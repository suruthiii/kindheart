        ...
        <div class="donor-right-side-container">
            ...
            <div class="donor-middle-container">
                ...
                <div class="benefactionRequestAccepted-left-column">   
                    <div class="benefactionRequestAccepted-left-column-request-detail">
                        <div class="benefactionRequestAccepted-left-column-topic">
                            <h4>Request Details</h4>
                            <div class="benefactionRequestAccepted-left-column-grey-line"> </div>
                        </div>
                    ...
                    <div class="benefactionRequestAccepted-left-column-donation-detail">
                        <div class="benefactionRequestAccepted-left-column-topic">
                        ...
                        <div class="benefactionRequestAccepted-info">
                            ...
                            <table>
                                ...
                                <tr class="benefactionRequestAccepted-data">
                                    <th>Donated Date</th>
                                    <!-- <td><?php print_r($data['benefactionRequest_details'][0]->donatedDate); ?></td> -->
                                </tr>
                                <tr class="benefactionRequestAccepted-data">
                                    <th>Verfication Status</th>
                                    <!-- <td><?php print_r($data['benefactionRequest_details'][0]->status) ?></td> -->
                                </tr>
                                <tr class="benefactionRequestAccepted-data">
