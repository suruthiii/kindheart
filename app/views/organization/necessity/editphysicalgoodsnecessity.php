        ...
        <div class="right-side-container">
            ...
            <div class="middle-container">
                ...
                <div class="middle-container-title-typeone">
                    <h3>Edit (Good) Necessities</h3>
                    <p>Update correct information and add your necessities.</p>
                </div>

                <!-- Add goods Necessity Form -->
                <div class="add-necessity-form">
                    <form enctype="multipart/form-data" action="<?php echo URLROOT ?>/necessity/UpdatePhysicalGoodsNecessity" method="post" onsubmit="return validateForm()">
                        <!-- Necessity -->
                        <div class="add-necessity-one-line-second-type-input">
                            <div class="necessity-third-div">
                                ...
                                <select id="necessityCategory" name="necessityCategory" style="background: #cfcece;" value="<?php echo isset($data['necessityCategory']) ? $data['necessityCategory'] : ''; ?>">
                            ...
                            <div class="necessity-fourth-div">
                                ...
                                <input type="text" id="neccessityitem" name="neccessityitem" style="background: #cfcece;" title="Type the Necessity for the Necessity Type" value="<?php echo isset($data['neccessityitem']) ? $data['neccessityitem'] : ''; ?>">
...
<script>
    const necessityCategory = document.getElementById('necessityCategory');
    const necessityItem = document.getElementById('neccessityitem');

    necessityCategory.disabled = true;
    necessityItem.disabled = true;
</script>
