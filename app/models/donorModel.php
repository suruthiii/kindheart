...
class donorModel{
    ...
    //     // Prepare statement
    //     $this->db->query('UPDATE benefaction SET itemName = :itemName, itemQuantity = :itemQuantity, description = :description, donorID = :donorID, WHERE benefactionID = :benefactionID');
